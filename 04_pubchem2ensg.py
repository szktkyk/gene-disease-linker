...
parser = argparse.ArgumentParser(description="This script collects genes associated with disease from pubchem based on a pubchem disease ID, and writes it to a tsv file (./results).")
